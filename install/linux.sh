...
echo ""
echo "==> Build tools"
# build-essential: gcc, make, etc. | curl/wget: downloaders | unzip: archive extraction | git: version control
...
# python3/pip/tk: Python 3 + Tkinter (brew: python-tk@3.12) | ruby-full: Ruby
# golang: Go language | rustup: Rust toolchain installer
sudo apt-get install -y python3 python3-pip python3-tk ruby-full golang rustup
...
echo ""
echo "==> Databases"
# postgresql: server | postgresql-client: psql client
